...
import 'package:yuu_sell/presentation/screens/create_parcel/create_parcel_step3_page.dart';
...
class CreateParcelStep2Page extends StatelessWidget {
  const CreateParcelStep2Page({super.key});
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: const StepProgressBar(currentStep: 2),
          ),
                    ...
                    CustomButton(
                      ...
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => CreateParcelStep3Page(),
                          ),
                        );
                      },
                    ),
